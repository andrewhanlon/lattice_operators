...
def get_operator(op_line, anti, spin, orib):
  ...
  if anti:
    op = coeff*(Operator(sh.nucleon_p[row_1-1], mom_1)*Operator(sh.nucleon_m[row_2-1], mom_2) - Operator(sh.nucleon_m[row_1-1], mom_1)*Operator(sh.nucleon_p[row_2-1], mom_2))
  else:
